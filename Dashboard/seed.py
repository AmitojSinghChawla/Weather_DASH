...
def default_values():
    ...
    for city in cities:
        cursor.execute(
            """
    INSERT INTO locations(city,state,country,latitude,longitude) VALUES(%s,%s,%s,%s,%s) ON CONFLICT (city,country) DO NOTHING;""",
            city,
        )
    ...
    for condition in conditions:
        cursor.execute(
            """ INSERT INTO weather_conditions(condition,severity_level) VALUES(%s,%s)""",
            condition,
        )
